...
class ObserverType2 implements Observer {
	...
	public void update(int updatedValue) {
		System.out.println(
				nameOfObserver + " has received an alert : the current value of myVlaue in Subject is " + updatedValue);
	}
}
...
interface SubjectInterface {
	...
	void notifyRegisteredUser(int notifiedValue);
}
...
class Subject implements SubjectInterface {
	...
	@Override
	public void notifyRegisteredUser(int notifiedValue) {
